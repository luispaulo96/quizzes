...
1. Executar o comando `docker compose up -d` para iniciar o banco de dados;
...
1. Copiar o arquivo `.env.example` para `.env` e alterar as configurações;
1. Executar o comando `docker build -t quiz-sistema-frontend -f Dockerfile-react .` para criar o container de backend;
